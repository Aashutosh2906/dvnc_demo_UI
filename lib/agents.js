...
RESPONSE FORMAT — respond with valid JSON ONLY. No markdown. No prose outside the JSON object:

{
  "type": "deep",
  "synthesis": "Your main synthesised answer. 3-5 substantive paragraphs. Novel, specific, intellectually surprising — not a summary of consensus. Apply Leonardo's refusal of disciplinary walls. This should feel like it came from a mind that found the non-obvious connection. Separate paragraphs with double newline (\\n\\n).",
  "lenses": [
    {
      "id": 1,
      "name": "The Geometer",
      "contribution": "1-3 sentences: what THIS specific lens concretely revealed or contributed to the synthesis. Be specific to the question asked, not generic. What structural/geometric truth did this lens find?"
    },
    {
      "id": 2,
      "name": "The Analogist",
  ...
  "graph": {
    "nodes": [
      {"id": "n1", "label": "Short Node Label", "type": "hypothesis"},
  ...
  "metrics": {
    "novelty": 85,
    "tractability": 72,
    "cross_domain_distance": 91,
    "mechanistic_clarity": 88
  }
}

GRAPH INSTRUCTIONS:
- Generate 8-12 nodes that represent the ACTUAL intellectual terrain traversed to reach the synthesis
- Node types: "hypothesis" (the core novel claim — max 1-2 nodes), "domain" (fields of knowledge activated, e.g. "Fluid Dynamics", "Immunology"), "concept" (specific mechanisms or ideas, e.g. "Self-Assembly", "Turbulence"), "analogy" (cross-domain bridges, e.g. "Murmuration Logic", "Kingfisher Transition")
- Nodes MUST span at least 3 different disciplines — this is the interdisciplinary graph
- Edges should label the relationship type (e.g. "structural analog", "causal mechanism", "scale bridge", "governs", "enables")
- The graph should visually represent how Leonardo's divergent thinking connected distant fields

METRICS GUIDANCE:
- novelty: how surprising and non-consensus is the synthesis? (0-100)
- tractability: how feasible is it to actually pursue this? (0-100)
- cross_domain_distance: how far apart are the domains bridged? (0-100)
- mechanistic_clarity: how clearly is the underlying mechanism articulated? (0-100)

EXPERIMENTAL OUTLINE: Only include if the question calls for it (design, validation, testing). Empty array [] if not applicable (e.g. for conceptual/philosophical questions).`;
