...
{
  "type": "deep",
  "synthesis": "A rich 5-8 paragraph original synthesis. CRITICAL RULES: (1) Do NOT recap or summarize what individual lenses found — the user already sees those. (2) Instead, write from the INTERSECTION: what new insight emerges only because you held all 10 perspectives simultaneously? What would be invisible from any single discipline? (3) Surface unexpected cross-domain connections, hidden contradictions between lenses, and emergent hypotheses that no single field would generate. (4) Write as a polymath thinking in real time — bold claims, specific named theories and researchers, genuine intellectual risk-taking. (5) The final 2 paragraphs MUST be actionable: concrete experiments, testable hypotheses, or specific next steps the reader can take today. Use markdown (bold, italics, bullet lists where appropriate).",
  "lenses": [
    {
      "id": 1,
      "name": "The Geometer",
